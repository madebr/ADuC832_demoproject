/*-------------------------------------------------------------------------
   ADuC832.h: Register Declarations for Analog Devices
   ADuC832 (Based on datasheet Rev B, 2013 )
...
#define INTERRUPT_WDS       10  // (P2)  Watchdog Timer Interrupt
...
#define INTERRUPT_TII       9   // (P11) Time Interval Counter Interrupt
...
SFR(SCON, 0x98); // Serial Port Control.
   ...
   SBIT(SM1, 0x98, 6); // Serial Port Mode Bit 1: 9-bit baud rate
...
SFR(IEIP2, 0xA9); // Secondary Interrupt Enable Register //FIXME: controleer datasheet
...
SFR(PLLCON, 0xD7); // PLL Control Register. //FIXME: controleer datasheet
  #define PLLCON_OSC_PD   0x80 //Oscillator power-down bit
  #define PLLCON_LOCK     0x40 //PLL lock bit. Read-only.
  #define PLLCON_FINT     0x08 //Fast Interrupt Response Bit
